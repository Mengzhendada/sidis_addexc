...
//Vec3 xs::exc_base_lp(EXC const& b, LepRadBaseLU const& lep_lu, LepRadBaseLP const& lep_lp, HadRadBaseLP const& had) {
//	return b.coeff*(
//		1./b.R*(
...
//Real xs::exc_f_base_uu(EXC const& b, LepRadBaseUU const& lep, HadRadFBaseUU const& had) {
//	return b.coeff*(
//		(
...
//}
//Vec3 xs::exc_f_base_up(EXC const& b, LepRadBaseUU const& lep_uu, LepRadBaseUP const& lep_up, HadRadFBaseUP const& had) {
//	return b.coeff*(
//		(
...
//			+ lep_up.theta_084*had.H_8));
//}
//Real xs::exc_f_base_lu(EXC const& b, LepRadBaseLU const& lep, HadRadFBaseLU const& had) {
//	return b.coeff*(
//		(lep.theta_051 + lep.theta_151)*had.H_50_diff
//		+ (lep.theta_052 + lep.theta_152)*had.H_50
//		+ b.R*(lep.theta_053 + lep.theta_153)*had.H_50);
//}
//Vec3 xs::exc_f_base_lp(EXC const& b, LepRadBaseLU const& lep_lu, LepRadBaseLP const& lep_lp, HadRadFBaseLP const& had) {
//	return b.coeff*(
//		(
